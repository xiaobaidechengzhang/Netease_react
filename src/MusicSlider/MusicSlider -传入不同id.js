...
export default function MusicSlider(props) {
    ...
    useEffect(() => {
        ...
        back.addEventListener('click', (e) => {
            ...
            function searchPar(e) {
                if (e.id == (props.id+'back')) {
                    return e.scrollWidth;
                }
                else {
                    if (e.parentNode.id != (props.id+'back')) {
                        return searchPar(e.parentNode)
                    }
                    else if (e.parentNode.id == (props.id+'back')) {
                        let p = e.scrollWidth;
                        return p
                    }
                }
    ...
    */
    ...
    const changetext = () => {
        ...
        textRef.current.value = props.id;
    }
    /**
     * 播放列表组件
     */
    ...
    return (
        <div id={props.id}>
            ...
            <div style={{ margin: '0 50px', height: '10px', zIndex: 50 }} id={props.id+'back'} className='back'>
            ...
            <div className='musicActions'>
                ...
                >
                    ...
                    />
                    <div
                        className={[`${props.id+'sliderCon'} sliderCon` ]}
                    >
                        <input
                            type='range'
                            value={sliderVal}
